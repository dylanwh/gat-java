...
public interface IRepository {
	 ...
	 * @throws IOException 
	 */
	void attach(Path file, Asset asset) throws RepositoryException, IOException;
	 ...
	 * @throws IOException 
	 */
	boolean detach(Path file, Asset asset) throws RepositoryException, IOException;
	...
	/** Test the attachment between an arbitrary file and an asset.
 	 ...
 	 * @throws RepositoryException
 	 */
	boolean isAttached(Path file, Asset asset) throws RepositoryException;
	 ...
	 * @throws IOException 
	 */
	boolean  purge(Asset asset) throws RepositoryException, IOException;
	 ...
	 * @throws IOException 
	 */
	Asset store(Path file) throws RepositoryException, IOException;
}
;